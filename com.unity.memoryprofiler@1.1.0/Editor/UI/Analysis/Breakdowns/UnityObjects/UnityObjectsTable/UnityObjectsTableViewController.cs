...
namespace Unity.MemoryProfiler.Editor.UI
{
    class UnityObjectsTableViewController : TreeViewController<UnityObjectsModel, UnityObjectsModel.ItemData>
    {
        ...
        protected override void ConfigureTreeView()
        {
            ...
            m_TreeView.AddManipulator(new ContextualMenuManipulator(PopulateOpenSnapshotOptionMenu));
        }
        
        void PopulateOpenSnapshotOptionMenu(ContextualMenuPopulateEvent binder)
        {
            binder.menu.AppendAction("Dump Unity Objects", (a) =>
            {
                ...
                MemoryProfilerPlus.UnityObjectInfosDumper(m_Snapshot, itemData, m_Model);
            });
            
            binder.menu.AppendAction("Dump All Unity Objects", (a) =>
            {
                MemoryProfilerPlus.AllUnityObjectInfosDumper(m_Snapshot, m_Model);
            });
        }
